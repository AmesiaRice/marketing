...
const clientId = "434880690733-aq7emrn4cggbdram9pi4rg4u84h1thg0.apps.googleusercontent.com";
  ...
  return (
    <GoogleOAuthProvider clientId={clientId}>
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
        ...
        {flag && <GoogleLogin onSuccess={handleLoginSuccess} onError={() => console.log("Login Failed")} />}
          ...
          <table className="mt-4 border-collapse border border-gray-400">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border border-gray-400 p-2">Actions</th> {/* Add Actions column */}
              </tr>
            </thead>
            <tbody>
              {filteredData.map((row, rowIndex) => (
                ...
                >
                  {row.map((cell, cellIndex) => (
                    <td key={cellIndex} className="border border-gray-400 px-12 py-4">
                      {cell}
                    </td>
                  ))}
